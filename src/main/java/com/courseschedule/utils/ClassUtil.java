...
public class ClassUtil {
     ...
     */
    public static final int MAX_CLASS_TIME = 25;// 一周5天*每天5大节
    ...
    private static int calculateMainExpect(String classTime) {
        ...
        if (ArrayUtil.contains(tenExpectValue, classTime)) {
            return 10;
        } else if (ArrayUtil.contains(eightExpectValue, classTime)) {
            return 10;
        } else if (ArrayUtil.contains(fourExpectValue, classTime)) {
            return 4;
        } else if (ArrayUtil.contains(twoExpectValue, classTime)) {
            return 2;
        } else {
            return 0;
        }
    ...
    private static int calculateExperimentExpect(String classTime) {
        ...
        if (ArrayUtil.contains(tenExpectValue, classTime)) {
            ...
            return 8;
        } else if (ArrayUtil.contains(sixExpectValue, classTime)) {
            return 6;
        } else if (ArrayUtil.contains(fourExpectValue, classTime)) {
            return 4;
        } else {
    ...
    private static int judgingDiscreteValues(int temp) {
        ...
        if (ArrayUtil.contains(tenExpectValue, temp)) {
            return 10;
        } else if (ArrayUtil.contains(sixExpectValue, temp)) {
            return 6;
        } else if (ArrayUtil.contains(fourExpectValue, temp)) {
            return 4;
        } else if (ArrayUtil.contains(twoExpectValue, temp)) {
            return 2;
        } else {
            return 0;
        }
